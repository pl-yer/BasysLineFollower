...
##Pmod Header JA
#Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {sensors[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sensors[0]}]
#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {sensors[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sensors[1]}]
# #Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {sensors[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sensors[2]}]
# #Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {sensors[3]}]					
